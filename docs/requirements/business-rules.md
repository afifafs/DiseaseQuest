...
This document collects the policies, regulations, standards, and formulas that govern DiseaseQuestv2 so that the project's software requirements can reference these rules without restating them. It will be updated as additional business rules are identified and confirmed with the client.
